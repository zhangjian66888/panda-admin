  ...
  export default {
    ...
    data() {
      return {
        ...
        saveRoleUrl: '/panda/core/group/saveRole',
        deleteRoleUrl: '/panda/core/group/deleteRole',
        searchDto: {},
        records: [],
      ...
      bindRole(val) {
        ...
        if (!binded) {
          _util.requestPost(this, this.saveRoleUrl, {groupId: this.groupId, roleId: val.id}, (data) => {
            this.selectedTags.push({id: val.id, name: val.roleName});
          });
        }
      },
      removeRole(val) {
        _util.requestPost(this, this.deleteRoleUrl, {groupId: this.groupId, roleId: val.id}, () => {
